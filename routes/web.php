...
Route::get('/all-brand-product', 'App\Http\Controllers\BrandProduct@all_brand_product'); ///ok
...
Route::get('/all-lonhap', 'App\Http\Controllers\ImportController@all_lonhap'); ///ok
...
Route::get('/all-loxuat', 'App\Http\Controllers\ExportController@all_loxuat'); ///ok
...
//Đánh giá --+BHang
Route::get('/danh-gia', 'App\Http\Controllers\OrderController@all_comment'); ///ok
Route::get('/delete-danhgia/{DG_MA}', 'App\Http\Controllers\OrderController@delete_comment'); ///

//Phí ship
Route::get('/show_feeship', 'App\Http\Controllers\AdminController@show_feeship'); ///ok
...
Route::get('/all-chucvu', 'App\Http\Controllers\JobController@all_chucvu'); ///ok
...
Route::get('/all-hinhthuc-thanhtoan', 'App\Http\Controllers\PaymentController@all_hinhthuc_thanhtoan'); ///ok
