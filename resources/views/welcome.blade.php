...
<head>
    ...
    <link rel="stylesheet" href="{{asset('public/frontend/bootstrap/css4/bootstrap.min.css')}}"
        integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">
...
<body>
    ...
    <footer class="mt-5 py-5">
        ...
        <div id='top-buttom_image'>
            <a href='#' title='Lên đầu trang'><img style=' position:fixed; bottom:3%; right:3%; clip:inherit; width:6%; width: 50px; border-radius: 5px' alt='Lên đầu trang' src="{{('public/frontend/img/back-top.jpg')}}"/></a><br/>
        </div>
    </footer>
