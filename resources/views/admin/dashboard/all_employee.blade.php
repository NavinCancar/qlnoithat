      ...
      <div class="row">
        <div class="col-sm-5 text-center">
          <small class="text-muted inline m-t-sm m-b-sm">
            {{ "Hiển thị ". $all_employee->firstItem() ."-". $all_employee->lastItem() ." trong ". $all_employee->total() ." dòng dữ liệu" }}
          </small>
        </div>
        <nav aria-label="Page navigation">
          <div class="col-sm-7 text-right text-center-xs">
            <ul class="pagination pagination-sm m-t-none m-b-none">
              ...
              @else
                <li><a href="{{ $all_employee->previousPageUrl() }}">Trước</a></li>
              @endif
              ...
              @if ($all_employee->hasMorePages())
                <li><a href="{{ $all_employee->nextPageUrl() }}">Sau</a></li>
              @else
