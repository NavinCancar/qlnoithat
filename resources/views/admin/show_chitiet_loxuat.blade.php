                        ...
                        @foreach($edit_loxuat as $key => $edit_value)
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$edit_value->LX_NGAYXUAT}}" readonly name="ngayxuat_product_name" class="form-control" id="exampleInputEmail1" placeholder="Tên tác giả" required="">
                                </div>
                                <div class="form-group">
